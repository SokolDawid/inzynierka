...
--
-- Host: 127.0.0.1
-- Generation Time: Maj 30, 2025 at 04:33 PM
...
INSERT INTO `classes_members` (`MemberID`, `ChildID`, `ClassID`) VALUES
(4, NULL, 1),
(5, NULL, 7),
(6, 1, 1),
(7, 1, 7);
...
(18, 'awfafa', 'afwaf', NULL, 'mail20@mail.com', NULL, '$2y$12$wiymQhf7LCG4ekFdph/Ot.AUt8Zoxo9kawac0A8Z55VnYCLHSvSKO', '213123123', 17, NULL, '2025-05-27 17:56:35', '2025-05-27 17:56:59', 'd4IkiCMNxHT8HB2RN29o90tSiUDsnF6HWAoELTjdgPrHvnZAvtMqKAOWuL8i', NULL, NULL, NULL),
...
--
ALTER TABLE `attendance`
  MODIFY `AttendanceID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `schedule`
  MODIFY `ScheduleID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
